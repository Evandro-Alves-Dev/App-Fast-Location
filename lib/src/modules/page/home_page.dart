    ...
    return Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
              onPressed: () {},
              icon: const Icon(
                  Icons.check)), // verificar e colocar o incone certo
        ),
        body: Center(
            child: Column(
              ...
              Container(
                margin: const EdgeInsets.only(left: 20, right: 20, bottom: 300),
                child: const Row(
              ...
              Container(
                ...
                child: const Text('Ultimos endereços localizados'),
              ),
              Container(
                ...
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all(
                      const Color.fromARGB(255, 34, 109, 37)),
